...
with st.sidebar:
    ...
    st.radio(
        "Navigation",
        ["🏠 Home", "📝 Analyzer", "🎬 File Analysis", "🤖 Chat Analyzer", "📚 History", "ℹ️ About"],
        key="page",
...
if st.session_state.page == "🏠 Home":
    ...
    <div class="feature-badges">
        ...
        <span class="badge">💬 Chat Analyser</span>
    ...
    with col3:
        st.button("🤖 Chat Analyser", on_click=set_page, args=["🤖 Chat Analyzer"], use_container_width=True)
